...
<table>
  <tr>
    ...
    <td id = 'name{num}'>LEGO Science Element = </td>
    <td><input id = 'var{num}' maxlength = 20 type='text' value = "motor" style='width: 60px; border: none; color: #0000FF'> </td>
    <td><select id="dropdown{num}"></select></td>
    <td style="width: 50px; text-align: center"><label id = "value{num}">0</label></td>
    <td> </td>
  </tr>
</table>
<div style = 'visibility: hidden; color:#0000FF; width: 800px; font-size: 9px' id = "activity{num}"></div>
'''
